  ...
  <div v-show="loaded" id="root">
    <header>
      ...
      <div class="darkmode-switch">
        <a-switch v-model="darkModeValue" @change="handleDarkModeChange">
          <template #checkedChildren>
            <svg viewBox="-4 -2 24 24" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin"
              class="jam jam-moon" style="width: 16px !important; padding-top: 2px;">
              <path fill="white"
          ...
          <template #unCheckedChildren>
            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
              style="width: 16px !important; padding-top: 2px;">
              <path fill="white"
